...
<Callout type="warning">
  ...
  existing solutions technologies that don't exist yet (without working towards
  building them), or skip over the consensus question entirely. "How are you
  planning to have trusted verifiable inference in a decentralized system?" is a
...
<Callout type="info">
  **The name "Rakis" is an omage to the new name for Arrakis under Leto. Nodes
  in the Rakis network are called Synthients, after the race of embodied AIs in
  the Matrix universe.**
</Callout>
