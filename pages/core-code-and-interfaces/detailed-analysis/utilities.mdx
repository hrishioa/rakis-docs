...
These utilities are particularly useful in scenarios where many events or operations need to be processed, such as handling incoming packets or processing inference requests.

By leveraging these utilities, Rakis maintains a consistent and efficient codebase, ensuring secure communication, accurate logging, and streamlined operations.